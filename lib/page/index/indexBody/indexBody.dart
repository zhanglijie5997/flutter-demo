...
import 'package:flutter_app/components/swiper/swiper.dart';
import 'package:flutter_app/page/seach/seach.dart';
import 'package:flutter_app/utils/screenUtil.dart';

class IndexBody extends StatefulWidget {
  IndexBody({Key key,this.data, this.list, this.bannerList}): super(key : key);
  final List data;
  final List list;
    ...
    Widget body = Container(
      child: Stack(
        children: <Widget>[
          ...
          //   child: Container(
          //     width: settingWidth(710),
          //     height: settingHeight(330),
          //     child:SwiperWidget(bannerList: widget.bannerList,)
          //   ) 
            // Image.network("https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=1282530439,643532505&fm=26&gp=0.jpg", 
